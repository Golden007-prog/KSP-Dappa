...
SLIDES = [
    ...
    },
    {
        ...
        "bullets": [
            ...
            "Quality: 784-assertion API contract suite plus a 34-check live smoke script; GitHub Actions builds the static demo mirror.",
        ],
        "size": 11.2,
    },
    {
    ...
    },
    {
        ...
        "bullets": [
            ...
            "Verification: 784-assertion contract suite green, 34/34 live smoke checks green against the deployed URL.",
        ],
        "size": 10.8,
    },
    {
    ...
    },
    {
        "slideNumber": 14,
        "bullets": [
            "Known limitation — QuickML case-status model measures AUC 0.500. Case status in this synthetic corpus is driven by registration recency, which QuickML cannot",
            "use as a feature: Type Conversion offers only Text/Timestamp for a Date, Custom Expression is arithmetic-only, and Custom Code (Python) needs a Zoho support request.",
