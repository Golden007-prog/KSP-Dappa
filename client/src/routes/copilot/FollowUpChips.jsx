...
// chip is guaranteed to parse into a real answer. The chip text stays English:
// it is a query string the backend's intent grammar has to parse.
...
export default function FollowUpChips({ items = [], onPick, disabled = false }) {
  ...
  return (
    <div className="no-print flex flex-wrap items-center gap-1.5 pl-9" aria-label={t('copilot.followUp.aria')}>
